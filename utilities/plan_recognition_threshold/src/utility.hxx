...
//std::string print_fluent_vec(aptk::STRIPS_Problem& prob, std::vector<unsigned int> f_v);
...
std::string print_action_vec(const aptk::STRIPS_Problem& prob, std::vector<unsigned int> a_v);
