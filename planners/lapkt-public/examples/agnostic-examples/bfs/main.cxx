...
using LM_C = aptk::agnostic::Landmarks_Count_Heuristic<Fwd_Search_Problem>;
...
typedef		AT_BFS_SQ_SH< Fwd_Search_Problem, LM_C, BFS_Open_List >		Anytime_BFS_LM_C;
typedef		AT_WBFS_SQ_SH< Fwd_Search_Problem, LM_C, BFS_Open_List >	Anytime_WBFS_LM_C;
...
int main( int argc, char** argv ) {
	...
	Anytime_WBFS_LM_C bfs_engine( search_prob );
	...
	Anytime_WBFS_LM_C wbfs_engine( search_prob, W_0, decay);
