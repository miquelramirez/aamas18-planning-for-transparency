...
public:
  ...
  const std::vector<double>& belief_state() const { return m_belief_state;  }
  std::vector<double>& belief_state(){ return m_belief_state;  }

  void set_bs( std::vector<double> bs ){ m_belief_state = bs; }
  std::vector<double>& get_bs(){ return m_belief_state; }
