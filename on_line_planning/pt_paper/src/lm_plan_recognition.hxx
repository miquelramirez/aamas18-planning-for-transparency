...
namespace pr_lm {
  ...
  public:
    ...
    PlanRecognitionEngine_LM(aptk::STRIPS_Problem * s_prob, Goal_set goal_set, double theta, bool verbose, std::vector<double> priors);
    PlanRecognitionEngine_LM(aptk::STRIPS_Problem const * s_prob, Goal_set goal_set, double theta, bool verbose, std::vector<double> priors);
